...
## Hey Cole as Your Personal Assistant
...
> **Cole:** "🥥 Pure sabor, but wait—what makes yours better than the 500 existing ones? Who is paying for this on Day 1? And why build from scratch when you can use X?"
...
**When to use:** Issue management, team coordination, code review prep.

**When to use:** Software engineering, architecture, code review.
